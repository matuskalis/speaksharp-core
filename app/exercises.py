...
_add_exercise(Exercise(
    ...
    skill_keys=['grammar_present_simple_third_person']
))
...
_add_exercise(Exercise(
    ...
    skill_keys=['grammar_comp_er_est']
))
...
_add_exercise(Exercise(
    ...
    skill_keys=['grammar_past_simple_regular']
))
...
_add_exercise(Exercise(
    ...
    skill_keys=['grammar_future_will']
))
...
_add_exercise(Exercise(
    ...
    skill_keys=['vocab_everyday_body']
))
...
_add_exercise(Exercise(
    ...
    skill_keys=['vocab_describe_feelings']
))
...
_add_exercise(Exercise(
    ...
    skill_keys=['vocab_action_movement']
))
...
_add_exercise(Exercise(
    ...
    skill_keys=['vocab_everyday_colors']
))
...
_add_exercise(Exercise(
    ...
    skill_keys=['grammar_present_simple_question']
))
...
_add_exercise(Exercise(
    ...
    skill_keys=['grammar_there_is_are']
))
...
_add_exercise(Exercise(
    ...
    skill_keys=['grammar_present_simple_negative']
))
...
_add_exercise(Exercise(
    ...
    skill_keys=['grammar_article_a_an']
))
...
_add_exercise(Exercise(
    ...
    skill_keys=['grammar_prep_in_on_at']
))
...
_add_exercise(Exercise(
    ...
    skill_keys=['grammar_comp_more_most']
))
...
_add_exercise(Exercise(
    ...
    skill_keys=['grammar_future_going_to']
))
...
_add_exercise(Exercise(
    ...
    skill_keys=['grammar_article_countable']
))
...
_add_exercise(Exercise(
    ...
    skill_keys=['grammar_present_cont_affirmative']
))
...
_add_exercise(Exercise(
    ...
    skill_keys=['grammar_modal_would']
))
...
_add_exercise(Exercise(
    ...
    skill_keys=['grammar_modal_should']
))
...
_add_exercise(Exercise(
    ...
    skill_keys=['grammar_prep_movement']
))
...
_add_exercise(Exercise(
    ...
    skill_keys=['grammar_pronoun_demonstrative']
))
...
_add_exercise(Exercise(
    ...
    skill_keys=['grammar_modal_may_might']
))
...
_add_exercise(Exercise(
    ...
    skill_keys=['vocab_describe_weather']
))
...
_add_exercise(Exercise(
    ...
    skill_keys=['vocab_situation_shopping']
))
...
_add_exercise(Exercise(
    ...
    skill_keys=['vocab_describe_time']
))
...
_add_exercise(Exercise(
    ...
    skill_keys=['vocab_everyday_home']
))
...
_add_exercise(Exercise(
    ...
    skill_keys=['vocab_describe_size']
))
...
_add_exercise(Exercise(
    ...
    skill_keys=['vocab_everyday_food']
))
...
_add_exercise(Exercise(
    ...
    skill_keys=['vocab_everyday_greetings']
))
...
_add_exercise(Exercise(
    ...
    skill_keys=['vocab_action_daily_routine']
))
...
_add_exercise(Exercise(
    ...
    skill_keys=['vocab_everyday_clothes']
))
...
_add_exercise(Exercise(
    ...
    skill_keys=['vocab_situation_airport']
))
...
_add_exercise(Exercise(
    ...
    skill_keys=['vocab_action_leisure']
))
...
_add_exercise(Exercise(
    ...
    skill_keys=['vocab_action_travel']
))
...
_add_exercise(Exercise(
    ...
    skill_keys=['vocab_situation_directions']
))
...
_add_exercise(Exercise(
    ...
    skill_keys=['vocab_colloc_make_do']
))
...
_add_exercise(Exercise(
    ...
    skill_keys=['vocab_situation_work']
))
...
_add_exercise(Exercise(
    ...
    skill_keys=['vocab_phrasal_basic']
))
...
_add_exercise(Exercise(
    ...
    skill_keys=['vocab_phrasal_common']
))
...
_add_exercise(Exercise(
    ...
    skill_keys=['vocab_colloc_adj_noun']
))
...
_add_exercise(Exercise(
    ...
    skill_keys=['grammar_pronoun_subject', 'grammar_pronoun_object']
))
...
_add_exercise(Exercise(
    ...
    skill_keys=['grammar_pronoun_object']
))
...
def get_exercises_by_level(level: str) -> List[Exercise]:
    """Get all exercises for a specific level."""
    return [ex for ex in EXERCISES.values() if ex.level == level]


def get_exercises_by_skill(skill: SkillType) -> List[Exercise]:
    """Get all exercises for a specific skill type."""
    return [ex for ex in EXERCISES.values() if ex.skill == skill]


def get_exercises_by_type(exercise_type: ExerciseType) -> List[Exercise]:
    """Get all exercises of a specific type."""
    return [ex for ex in EXERCISES.values() if ex.exercise_type == exercise_type]
...
def get_random_exercise(
    ...
    if level:
        exercises = [ex for ex in exercises if ex.level == level]
    if skill:
        exercises = [ex for ex in exercises if ex.skill == skill]
    if exercise_type:
...
def get_exercises_by_skill_key(skill_key: str) -> List[Exercise]:
    """Get all exercises that train a specific skill_key."""
    return [ex for ex in EXERCISES.values() if ex.skill_keys and skill_key in ex.skill_keys]


def get_exercises_for_skills(skill_keys: List[str]) -> List[Exercise]:
    """Get all exercises that train any of the specified skill_keys."""
    return [ex for ex in EXERCISES.values()
            if ex.skill_keys and any(sk in ex.skill_keys for sk in skill_keys)]
